...
import { IconSun, IconMoon, IconPower } from '@tabler/icons-vue'
  ...
  <CModal :visible="visible" alignment="top" @close="close">
    ...
    <div class="modal-body">
      <div class="d-flex align-items-center justify-content-between mb-2">
        <span class="small">{{ t('settings.language') }}</span>
        <select
      ...
      <div class="d-flex align-items-center justify-content-between">
        <span class="small">{{ t('settings.lock') }}</span>
        <button type="button" class="btn btn-sm d-flex align-items-center gap-1 text-danger" @click="lock">
          <IconPower :size="18" stroke-width="1" />
        </button>
      </div>
    </div>
